...
![回力标和树枝之间的比较](/web-resources/blob/printf/image-20190925142438729.png)
...
![一个供人们玩乐、即兴表演的溜冰场](/web-resources/blob/printf/image-20190925142800458.png)
...
![一个叫做 'DANGER IL Y A UN HOMME ARMÉ DANS CET ÉDIFICE 3' 的复古网页游戏的 HTML 表单](/web-resources/blob/printf/page4image9328736.png)

“这不是真正的电子游戏，”我被这样告知，“这只是个 HTML 表单。你应该为文本和选项使用数组，那样它会变得更好。你的代码也还需要清理。”  

我有些沮丧；我写了十一页文字来描绘这个游戏的“选择你的冒险”片段。不过我发现，如果我想要做一些能让更多人认同的东西，我必须学许多东西。  
...
![《计算机程序的构造和解释》的封面](/web-resources/blob/printf/sicp.png)
...
![小 Printf，戴着红黄交织的绒帽，颜色相似的围巾、绿大衣、红手套、米黄色的裤子。站在雪地中，身旁是一台坏了的笔记本电脑](/web-resources/blob/printf/image-20190927111435190.png)
...
![某张复杂的架构图](/web-resources/blob/printf/page8image50221744.png)

他看了看，然后说：*“不，这个系统还不够好，给我别的。”*。所以我整了这个：

![一张甚至更加复杂的架构图](/web-resources/blob/printf/a-even-more-complex-arch.png)
...
![一个黑盒子，下面写着“Enjoy”](/web-resources/blob/printf/page9image50252848.png)
...
![一碗意大利面](/web-resources/blob/printf/image-20191013131559295.png)
...
![一个建筑物](/web-resources/blob/printf/image-20191021231614013.png)

他到了工作区，去找寻有经验的开发者，那些可以给他提示和帮助的人们。

他遇到的第一个十分傲慢的资深开发者，那人看上去感觉更加像是管理人员。

![一个穿着西装、戴着厚厚镜片的地中海男人。](/web-resources/blob/printf/image-20191021231933880.png)
...
![一个男人，坐在桌子前面，身后是几个放满的书架](/web-resources/blob/printf/image-20191119140508995.png)
...
“谢谢，我觉得它们是程序员最重要的材料。如果你没有它们，你就不是真正的 pro。”
...
![无特征的程序员坐在显示器的背光处，桌上放了一块三明治。](/web-resources/blob/printf/image-20191123143531388.png)
...
![一个燃烧着的垃圾桶，前方是烫金的牌子，牌子上写着“编程”](/web-resources/blob/printf/image-20191120131436807.png)
...
![一个男人在他桌上的两个显示器前](/web-resources/blob/printf/image-20191121221834741.png)
...
![一个穿着紫色兜帽衫的女生，无精打采地趴在放满了瓶子和杯子的桌上。](/web-resources/blob/printf/image-20191123143531388.png)
...
“没错；而且你是最熟悉那些问题的人，因此只能在其上工作得越来越多，直到雇主雇上另一个人来接替你的旧工作，那位你所爱之人。**如果你足够用力地关心你做的这些脏活累活，你就会因为你不喜欢的工作一次又一次被感谢，直到你包揽下所有。而后此处没有留下任何让你感到乐趣的东西了。**”
...
![软件架构师坐在放了若干令文档的桌子前](/web-resources/blob/printf/image-20191126172110029.png)
...
![穿着格子衫、戴着冬帽的男人，手上拿着圣铃和写字板](/web-resources/blob/printf/image-20191130150943306.png)
...
![和之前的 Printf 一样，但是面带微笑。](/web-resources/blob/printf/image-20191130170513927.png)
